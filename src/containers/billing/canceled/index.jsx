...
import { OnlySuperAdmin } from '../../../utils/routesPermission';
...
const CancelledInvoice = ({
  ...
  const infoDialog = () => {
    return (
      ...
      >
        <DialogContent>
          <BillingInfo data={current} emptyText={'Canceled'} />
        </DialogContent>
        <DialogActions
...
const mapStateProps = (state) => {
  return {
    ...
    data: state.billing.validateInvoice.canceled.result,
...
export default connect(mapStateProps, mapDispatchToProps)(CancelledInvoice);
