...
const DisputedInvoice = ({
  ...
  const infoDialog = () => {
    return (
      ...
      >
        <DialogContent>
          <BillingInfo data={current} emptyText={'Disputed'} />
        </DialogContent>
        <DialogActions
  ...
  //             {renderDetails(
  //               'Account',
  //               strictValidArrayWithLength(currentViewData)
  //                 ? currentViewData[0].name
  //                 : 'N/A',
  //             )}
  //             {renderDetails(
  //               'PO Numner',
  //               strictValidArrayWithLength(currentViewData)
  //                 ? currentViewData[0].po_number
  //                 : 'N/A',
  //             )}
  //             {renderDetails(
  //               'Billing Address',
  //               strictValidArrayWithLength(currentViewData)
  //                 ? currentViewData[0].billing_address
  //                 : 'N/A',
  //             )}
  ...
  //               'Invoice',
  //               strictValidArrayWithLength(currentViewData)
  //                 ? currentViewData[0].invoice_id
  //                 : 'N/A',
  //             )}
  //             {renderDetails(
  //               'Legs count',
  //               strictValidArrayWithLength(currentViewData)
  //                 ? currentViewData[0].legs_count
  //                 : 'N/A',
  //             )}
  //           </Box>
  //         </Box>
  ...
  //               accessor: (originalRow, rowIndex) => {
  //                 return (
  //                   strictValidObjectWithKeys(originalRow) && originalRow.leg_id
  //                 );
  //               },
  //               Cell: (props) => (
  //                 <Stack>
  ...
  //                       )}, PU : ${originalRow.billing_postal_code}, PD : ${
  ...
  //                                   props.row.original.pick_up_date_time,
  //                                 )}
  //                             , PU: {props.row.original.billing_postal_code},
  //                             PD: {props.row.original.billing_postal_code},
  //                             Patient Name: {props.row.original.first_name}{' '}
  ...
  //                                   .first_name +
  //                                 ' ' +
  //                                 props.row.original.contact_details.last_name +
  //                                 ', tel: ' +
  //                                 (strictValidString(
  //                                   props.row.original.contact_details
  //                                     .phone_number[0],
  ...
  //                                 ', Email: ' +
  //                                 (strictValidString(
  //                                   props.row.original.contact_details.email_id,
  //                                 )
  //                                   ? props.row.original.contact_details
  //                                       .email_id
  //                                   : 'N/A')}
  ...
  //                             )}
  //                             , PU: {props.row.original.billing_postal_code},
  //                             DO: {props.row.original.billing_postal_code},
  //                             Patient Name: {props.row.original.first_name}{' '}
  //                             {props.row.original.last_name}
  //                             {props.row.original.name}
  //                             {', '}
...
const mapStateProps = (state) => {
  return {
    ...
    data: state.billing.validateInvoice.disputed.result,
...
export default connect(mapStateProps, mapDispatchToProps)(DisputedInvoice);
