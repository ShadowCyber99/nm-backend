...
const ValidateInvoice = ({
  ...
  const infoDialog = () => {
    return (
      ...
      >
        <DialogContent>
          <BillingInfo data={current} emptyText={'Validated'} />
        </DialogContent>
        <DialogActions
                  ...
                  <Tooltip title="Info" disableInteractive>
                    <IconButton
                      ...
                      onClick={() => {
                        ...
                        setCurrent(field);
                        infoToggle();
                        // callAuditApi({ invoice_id: field.invoice_id });
...
const mapStateProps = (state) => {
  return {
    ...
    data: state.billing.validateInvoice.validate.result,
...
export default connect(mapStateProps, mapDispatchToProps)(ValidateInvoice);
