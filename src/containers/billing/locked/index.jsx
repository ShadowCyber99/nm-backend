...
const LockedInvoice = ({
  ...
  const infoDialog = () => {
    return (
      ...
      >
        <DialogContent>
          <BillingInfo data={current} emptyText={'Locked'} />
        </DialogContent>
        <DialogActions
...
const mapStateProps = (state) => {
  return {
    ...
    data: state.billing.validateInvoice.locked.result,
...
export default connect(mapStateProps, mapDispatchToProps)(LockedInvoice);
