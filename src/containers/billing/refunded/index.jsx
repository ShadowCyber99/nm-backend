...
const RefundedInvoice = ({
  ...
  const infoDialog = () => {
    return (
      ...
      >
        <DialogContent>
          <BillingInfo data={current} emptyText={'Refunded'} />
        </DialogContent>
        <DialogActions
...
const mapStateProps = (state) => {
  return {
    ...
    data: state.billing.validateInvoice.refunded.result,
...
export default connect(mapStateProps, mapDispatchToProps)(RefundedInvoice);
