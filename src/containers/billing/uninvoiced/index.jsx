...
const UnInvoiced = ({
  ...
  const infoDialog = () => {
    return (
      ...
      >
        <DialogContent>
          <BillingInfo data={current} emptyText={'Uninvoiced'} />
        </DialogContent>
        <DialogActions
...
const mapStateProps = (state) => {
  return {
    ...
    data: state.billing.validateInvoice.uninvoiced.result,
...
export default connect(mapStateProps, mapDispatchToProps)(UnInvoiced);
