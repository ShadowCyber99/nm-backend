...
import { OnlySuperAdmin, OnlyAdmins } from '../../../utils/routesPermission';
...
const FullyPaidInvoice = ({
  ...
  const infoDialog = () => {
    return (
      ...
      >
        <DialogContent>
          <BillingInfo data={current} emptyText={'Fully Paid'} />
        </DialogContent>
        <DialogActions
...
const mapStateProps = (state) => {
  return {
    ...
    data: state.billing.validateInvoice.fullyPaid.result,
...
export default connect(mapStateProps, mapDispatchToProps)(FullyPaidInvoice);
