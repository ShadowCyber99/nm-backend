...
const SentInvoice = ({
  ...
  const infoDialog = () => {
    return (
      ...
      >
        <DialogContent>
          <BillingInfo data={current} emptyText={'Sent'} />
        </DialogContent>
        <DialogActions
...
const mapStateProps = (state) => {
  return {
    ...
    data: state.billing.validateInvoice.sent.result,
...
export default connect(mapStateProps, mapDispatchToProps)(SentInvoice);
